...
public:
  ...
  virtual ResourceTransferRHI uploadTexture(ResourceIdRHI id,
                                            UploadTextureRHI uploadTexture) = 0;
  virtual void releaseTexture(ResourceIdRHI id) = 0;

  virtual ResourceRHI& initMeshResource() = 0;
  virtual ResourceTransferRHI uploadMesh(ResourceIdRHI id,
                                         UploadMeshRHI uploadMesh) = 0;
  virtual void releaseMesh(ResourceIdRHI id) = 0;

  virtual ResourceRHI& initShaderResource() = 0;
  virtual ResourceTransferRHI uploadShader(ResourceIdRHI id,
                                           UploadShaderRHI uploadShader) = 0;
  virtual void releaseShader(ResourceIdRHI) = 0;

  virtual ResourceRHI& initMaterialResource() = 0;
  virtual ResourceTransferRHI
  uploadMaterial(ResourceIdRHI id, UploadMaterialRHI uploadMaterial) = 0;
